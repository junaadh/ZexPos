                ...
                {restaurant && (
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Configure settings specific to {restaurant.name}
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          <Label htmlFor="restaurant_gst_rate">GST Rate (%) - Override</Label>
                          <Input
                            id="restaurant_gst_rate"
                            type="number"
                            step="0.01"
                            min="0"
                            max="100"
                            defaultValue=""
                            placeholder={`Default: ${organizationSettings.tax_rate || '0'}%`}
                          />
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="restaurant_service_charge">Service Charge (%) - Override</Label>
                          <Input
                            id="restaurant_service_charge"
                            type="number"
                            step="0.01"
                            min="0"
                            max="100"
                            defaultValue=""
                            placeholder={`Default: ${organizationSettings.service_charge || '0'}%`}
                          />
                          <p className="text-xs text-muted-foreground">
                            Leave empty to use organization default
                          </p>
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          <Label>Kitchen Ticket Settings</Label>
                          <div className="flex items-center space-x-2">
                            <Switch
                              id="auto_print_kitchen"
                              defaultChecked={false}
                            />
                            <Label htmlFor="auto_print_kitchen">Auto-print kitchen tickets</Label>
                          </div>
                          <p className="text-xs text-muted-foreground">
                            Automatically print kitchen tickets when orders are placed
                          </p>
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2">
                            <Switch
                              id="show_gst_on_receipt"
                              defaultChecked={true}
                            />
                            <Label htmlFor="show_gst_on_receipt">Show GST breakdown on receipts</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <Switch
                              id="show_service_charge_on_receipt"
                              defaultChecked={true}
                            />
                            <Label htmlFor="show_service_charge_on_receipt">Show service charge on receipts</Label>
                          </div>
                        </div>
                      </div>
                    </CardContent>
